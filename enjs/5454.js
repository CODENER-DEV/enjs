...
const ProgressBar = class {
  ...
  render() {
    ...
    const paused = _ionic_global_b3fc28dd_js__WEBPACK_IMPORTED_MODULE_3__.c.getBoolean('_testing');
...
const renderIndeterminate = () => {
  return (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "track",
