...
/* harmony import */ var _button_active_513e9fff_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./button-active-513e9fff.js */ 5178);
...
/* harmony import */ var _haptic_6447af60_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./haptic-6447af60.js */ 7150);
/* harmony import */ var _capacitor_b4979570_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./capacitor-b4979570.js */ 4874);
/* harmony import */ var _index_7a14ecec_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-7a14ecec.js */ 6225);
/* harmony import */ var _index_ff313b19_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./index-ff313b19.js */ 9203);
/* harmony import */ var _gesture_controller_0fa396c4_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./gesture-controller-0fa396c4.js */ 619);
...
/* harmony import */ var _index_595d62c9_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./index-595d62c9.js */ 6710);
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidPresent", 7);
    this.willPresent = (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillPresent", 7);
    this.willDismiss = (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillDismiss", 7);
    this.didDismiss = (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidDismiss", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.B);
    };
  ...
  componentDidLoad() {
     ...
     */
    if (!this.gesture && (0,_ionic_global_b3fc28dd_js__WEBPACK_IMPORTED_MODULE_8__.b)(this) === 'ios' && this.wrapperEl) {
      this.gesture = (0,_button_active_513e9fff_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.wrapperEl, refEl => refEl.classList.contains('alert-button'));
  ...
  present() {
    ...
    return (0,C_Users_ekt_Documents_DOMINGO_evaluationIF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
      unlock();
    })();
  }
  /**
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_ekt_Documents_DOMINGO_evaluationIF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
      if (dismissed) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,C_Users_ekt_Documents_DOMINGO_evaluationIF_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_8fc6656c_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler, data);
        if (returnData === false) {
  ...
  renderCheckbox() {
    ...
    }, inputs.map(i => (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
    ...
    }, i.label)), mode === 'md' && (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  renderRadio() {
    const inputs = this.processedInputs;
    if (inputs.length === 0) {
  ...
  renderInput() {
    ...
    return (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      if (i.type === 'textarea') {
        ...
        }, (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", Object.assign({
          placeholder: i.placeholder,
          value: i.value,
          id: i.id,
          tabIndex: i.tabindex
  ...
  renderAlertButtons() {
    ...
    return (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    }, buttons.map(button => (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, button.htmlAttributes, {
      type: "button",
      id: button.id,
      ...
      class: "alert-button-inner"
    }, button.text), mode === 'md' && (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  ...
  render() {
    ...
    return (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: "alert-head"
    }, header && (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: hdrId,
      class: "alert-title"
    }, header), subHeader && (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: subHdrId,
      class: "alert-sub-title"
    }, subHeader)), this.renderAlertMessage(msgId), this.renderAlertInputs(), this.renderAlertButtons()), (0,_index_2d388930_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
